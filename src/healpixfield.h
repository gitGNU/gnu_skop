...
"const mat3 rot = mat3(cos(phi0), sin(phi0), 0,\n"
"		-cos(theta0)*sin(phi0), cos(theta0)*cos(phi0), sin(theta0),\n"
"		sin(theta0)*sin(phi0),-sin(theta0)*cos(phi0),cos(theta0));\n"
...
"  //float theta = acos(coor.y) - theta0;\n"
"  vec2 thetaphi = vec2(acos(coor.y),acos(coor.x/sin(acos(coor.y))));\n"
"  //float phi = acos(coor.x/sin(theta)) - phi0;\n"
...
"  //float theta = acos(x.y);\n"
"  //float phi = acos(x.x/sin(theta));\n"
"  return thetaphi;\n"
"}\n"
"\n"
"//vec4 jet(vec4 valvec){\n"
"vec4 jet(float val){\n"
"  //float val = valvec.x/(255.0*255.0)+valvec.y/255.0 + valvec.z;\n"
"  //val = (clamp(val,minv,maxv)-minv)/diff;\n"
